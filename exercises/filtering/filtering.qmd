...
**ANSWER** Who do you get as the first result, and what was his trueshooting percentage? Julian Reese and his true shooting percentage was 59.9%.
...
matches_2024 |>
  filter(team == 'Maryland Terrapins, Terps', date < '2024-09-05') |>
  group_by(team) |>
  summarise(
    total_attempts = sum(sh_att),
    total_on_goal = sum(so_g),
...
The Terps are off to a much better start this season than they were in the first seven games last season. They have 20 more shot attempts and of the 20, 15 are on goal. With 85 shots attempted and 46 of them being on goal, their shot on goal percentage grew from 47.7% in 2024 to 54.1% through the first games of 2025. This means the Terps are not just taking more shots but playing better offensively because the extra shots have significantly impacted their shot on goal percentage. Their offense was one of their biggest struggles last season as they went through a dry period struggling to score a goal so this shows improvement in their attack aspect of the game.