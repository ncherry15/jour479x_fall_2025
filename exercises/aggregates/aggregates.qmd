...
```
**Answer** This is displaying the statistics for all NBA players. I would not use this data to analyze players' statistics because one player can be listed under multiple teams. I first checked the shooting percentage then I realized this was not a good statistic to base a story off of because it has added factors. For example, Reece Beekman has the highest shooting percentage however, he has the least amount of minutes played, 2, causing him to have taken significantly less shots. 
...
**Answer** This is showing the breakdown of each position in the league. It is helpful because before we say SG averages more of a specific stat, we have to recognize they have significantly more data. Every other position has around the same amount throughout the league excluding SGs.
...
**Answer** These results draw the same conclusions as the prior however, it emphasizes the distance between SGs as it is now displayed in descending order.
...
**ANSWER** 
Shooting guards seem the most interesting to me because they seem to be the stars of the NBA. They have significantly more players and minutes played. Although PGs have a higher average minutes played, they also have a higher standard deviation. I also find it interesting that SGs have higher minutes not all of them are primary scorers. This could mean SGs have learned to be situational role players. A possible story is that SGs are the most reliable position to plug into a lineup, balancing star power with dependable role players. Their consistent minutes suggest teams trust them to provide both stability and versatility on the court.
